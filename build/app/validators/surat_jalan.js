...
export const suratJalanValidator = vine.compile(vine.object({
    picName: vine.string(),
    ...
    suratJalanItems: vine.array(vine.object({
...
export const updateSuratJalanValidator = vine.compile(vine.object({
