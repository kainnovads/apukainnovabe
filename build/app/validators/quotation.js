...
export const quotationValidator = vine.compile(vine.object({
    ...
    quotationItems: vine.array(vine.object({
...
export const updateQuotationValidator = vine.compile(vine.object({
    customerId: vine.number(),
    perusahaanId: vine.number().optional(),
    cabangId: vine.number().optional(),
