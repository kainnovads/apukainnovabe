...
export const purchaseOrderValidator = vine.compile(vine.object({
    ...
    date: vine.date(),
    dueDate: vine.date(),
    status: vine.enum(['draft', 'approved', 'rejected', 'received', 'partial']),
    poType: vine.enum(['internal', 'external']),
    ...
    purchaseOrderItems: vine.array(vine.object({
...
export const updatePurchaseOrderValidator = vine.compile(vine.object({
    vendorId: vine.number(),
    perusahaanId: vine.number().optional(),
    cabangId: vine.number().optional(),
    ...
    date: vine.date(),
    dueDate: vine.date(),
    status: vine.enum(['draft', 'approved', 'rejected', 'received', 'partial']).optional(),
    poType: vine.enum(['internal', 'external']),
    discountPercent: vine.number(),
    taxPercent: vine.number(),
