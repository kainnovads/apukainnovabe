...
export const createCutiValidator = vine.compile(vine.object({
...
export const createCutiBalanceValidator = vine.compile(vine.object({
...
export const updateCutiValidator = vine.compile(vine.object({
