...
export const salesInvoiceValidator = vine.compile(vine.object({
    ...
    status: vine.enum(['unpaid', 'partial', 'paid']).optional(),
...
export const updateSalesInvoiceValidator = vine.compile(vine.object({
    noInvoice: vine.string().unique({ table: 'sales_invoices', column: 'no_invoice' }).optional(),
    up: vine.string().optional(),
    email: vine.string().optional(),
