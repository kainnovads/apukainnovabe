...
export const salesReturnValidator = vine.compile(vine.object({
    ...
    status: vine.enum(['draft', 'approved', 'rejected']),
    ...
    salesReturnItems: vine.array(vine.object({
...
export const updateSalesReturnValidator = vine.compile(vine.object({
    noSr: vine.string().unique({ table: 'sales_returns', column: 'no_sr' }).optional(),
    customerId: vine.number(),
    perusahaanId: vine.number(),
    cabangId: vine.number(),
