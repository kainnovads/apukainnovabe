...
export default class StockOutsController {
    ...
    async getStockOutDetails({ params, response }) {
        try {
    ...
    async postStockOut({ params, response, auth }) {
    ...
    async postAllStockOut({ request, response, auth }) {
        const trx = await db.transaction();
        try {
    ...
    async getTotalStockOut({ response }) {
        try {
...
//# sourceMappingURL=stock_outs_controller.js.map