...
import { perusahaanValidator, updatePerusahaanValidator, } from '#validators/perusahaan_cabang';
        ...
        try {
            ...
            if (payload.logoPerusahaan && payload.logoPerusahaan instanceof MultipartFile) {
                try {
                    ...
                    const uploadResult = await this.storageService.uploadFile(payload.logoPerusahaan, 'perusahaan', true);
...
//# sourceMappingURL=perusahaans_controller.js.map