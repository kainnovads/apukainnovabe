...
export default class extends BaseSchema {
    ...
    async up() {
        this.schema.createTable(this.tableName, (table) => {
            ...
            table.uuid('quotation_id').references('id').inTable('quotations').onDelete('CASCADE').onUpdate('CASCADE').nullable();
...
//# sourceMappingURL=1749453733505_create_sales_orders_table.js.map